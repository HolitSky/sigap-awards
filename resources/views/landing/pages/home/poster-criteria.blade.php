...
<div class="wrapper">
    <div class="cv-juri-wrapper">
        ...
        <div class="cv-juri-header">
            <div class="cv-juri-icon">🖼️</div>
            <h1 class="cv-juri-title">Kriteria Poster SIGAP Award 2025</h1>
            <p class="cv-juri-subtitle">Panduan dan Kriteria Penilaian Poster</p>
        </div>
        ...
        <div class="pdf-viewer-container">
            <div class="pdf-controls">
                ...
                <div class="pdf-controls-right">
                    ...
                    <a href="{{ asset($pdfPath) }}" download="Kriteria Poster SIGAP Award 2025.pdf" class="pdf-btn" style="text-decoration: none;">
...
<script>
    ...
    function renderPage(num) {
        ...
        pdfDoc.getPage(num).then(function(page) {
            ...
            const containerHeight = canvasContainer.clientHeight - 40; // minus padding
            const viewport = page.getViewport({ scale: 1 });
            const scaleToFit = containerHeight / viewport.height;
            
            const finalViewport = page.getViewport({ scale: scaleToFit * scale });
