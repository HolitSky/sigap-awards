...
<div id="reminderModal" class="modal-overlay modal-reminder" style="display: none;">
    <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="reminderTitle">
        ...
        <div class="modal-body">
            ...
            <h3 class="reminder-subtitle">Terima kasih telah berpartisipasi dalam pengisian form penilaian SIGAP Award 2025 🙏🏻😁 <br> Nantikan pengumuman resmi dari kami. Sampai jumpa di Bali!</h3>
        </div>
