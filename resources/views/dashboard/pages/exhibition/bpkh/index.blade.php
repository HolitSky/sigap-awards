                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Penilaian Exhibition/Poster BPKH</h4>
                                    <p class="card-title-desc">Daftar penilaian exhibition/poster untuk BPKH.</p>
...
@push('styles')
    ...
    <style>
        ...
        #datatable-exhibition-bpkh th:nth-child(2) { width: 20% !important; }
        #datatable-exhibition-bpkh th:nth-child(3) { width: 13% !important; }
        #datatable-exhibition-bpkh th:nth-child(4) { width: 9% !important; text-align: center; }
        #datatable-exhibition-bpkh th:nth-child(5) { width: 8% !important; text-align: center; }
        #datatable-exhibition-bpkh th:nth-child(6) { width: 11% !important; text-align: center; }
        #datatable-exhibition-bpkh th:nth-child(7) { width: 10% !important; text-align: center; }
        #datatable-exhibition-bpkh th:nth-child(8) { width: 26% !important; }
        #datatable-exhibition-bpkh td:nth-child(2),
