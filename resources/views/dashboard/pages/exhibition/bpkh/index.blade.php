...
@push('styles')
    ...
    <style>
        ...
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(1) { width: 5% !important; min-width: 40px; text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(2) { width: 22% !important; max-width: 250px; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(3) { width: 15% !important; max-width: 180px; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(4) { width: 10% !important; text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(5) { width: 10% !important; text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(6) { width: 12% !important; text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(7) { width: 12% !important; text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh th:nth-child(8) { width: 14% !important; }
        
        body.admin-view-role #datatable-exhibition-bpkh td:nth-child(1) { text-align: center; }
        body.admin-view-role #datatable-exhibition-bpkh td:nth-child(2),
        body.admin-view-role #datatable-exhibition-bpkh td:nth-child(3) {
            white-space: normal !important;
            word-wrap: break-word !important;
