...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('dashboard.exhibition.bpkh.bulk-score.store') }}" id="bulk-score-form">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h4 class="card-title mb-1">Penilaian Kolektif Exhibition - {{ $forms->count() }} Peserta</h4>
                                    <p class="text-muted mb-0">Isi penilaian exhibition untuk setiap peserta. Semua penilaian akan disimpan sekaligus.</p>
                                </div>
                        ...
                        <h5 class="mb-0">
                            <button class="btn btn-link d-flex justify-content-between align-items-center w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $index }}" aria-expanded="true">
                                <span>
                                    ...
                                    <strong>{{ $form->nama_bpkh }}</strong> - {{ $form->petugas_bpkh }}
                    ...
                    <div id="collapse{{ $index }}" class="collapse show">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <h6 class="text-primary mb-3"><i class="mdi mdi-clipboard-list-outline me-1"></i> Aspek Penilaian Exhibition</h6>
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            ...
                                            <input type="number"
                                                   ...
                                                   required
                                                   placeholder="1-100"
                                                   value="{{ $userAssessments[$form->respondent_id]['aspek_scores'][$key] ?? '' }}">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" 
                                            name="participants[{{ $form->respondent_id }}][rekomendasi]" 
                                            required>
                                        <option value="">-- Pilih Rekomendasi --</option>
                                        <option value="Layak sebagai pemenang kategori" {{ ($userAssessments[$form->respondent_id]['rekomendasi'] ?? '') == 'Layak sebagai pemenang kategori' ? 'selected' : '' }}>Layak sebagai pemenang kategori</option>
                                        <option value="Layak sebagai nominasi utama" {{ ($userAssessments[$form->respondent_id]['rekomendasi'] ?? '') == 'Layak sebagai nominasi utama' ? 'selected' : '' }}>Layak sebagai nominasi utama</option>
                                        <option value="Perlu banyak improvisasi" {{ ($userAssessments[$form->respondent_id]['rekomendasi'] ?? '') == 'Perlu banyak improvisasi' ? 'selected' : '' }}>Perlu banyak improvisasi</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control"
                                              ...
                                              rows="2"
                                              placeholder="Tulis catatan atau komentar...">{{ isset($userAssessments[$form->respondent_id]) ? ($userAssessments[$form->respondent_id]['catatan'] ?? '') : '' }}</textarea>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-light">
                        <div class="card-body">
                            <h5 class="card-title mb-3">Informasi Bobot Penilaian Exhibition</h5>
                            <p class="text-muted small mb-3">Total bobot semua aspek adalah 100%</p>
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2">✓ Kesesuaian Tema: <strong>20%</strong></li>
                                        <li class="mb-2">✓ Kreativitas & Inovasi: <strong>25%</strong></li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2">✓ Kualitas Visual: <strong>20%</strong></li>
                                        <li class="mb-2">✓ Informasi & Pesan: <strong>20%</strong></li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2">✓ Daya Tarik: <strong>15%</strong></li>
                                    </ul>
                                </div>
                            </div>
                            <hr>
...
$(document).ready(function() {
    ...
    $('#bulk-score-form').on('submit', function(e) {
        ...
        // Check all required number inputs
        $('input[type="number"][required]').each(function() {
            if (!$(this).val()) {
                isValid = false;
                $(this).addClass('is-invalid');
                emptyFields.push($(this).closest('.card').find('strong').first().text());
            } else {
