                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('dashboard.exhibition.produsen.export', ['respondentId' => $form->respondent_id, 'format' => 'excel', 'type' => 'summary']) }}">
                                    <i class="bx bxs-file-export"></i> Excel Summary
                                </a></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.exhibition.produsen.export', ['respondentId' => $form->respondent_id, 'format' => 'pdf', 'type' => 'summary']) }}">
                                    <i class="bx bxs-file-pdf"></i> PDF Summary
                                </a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><h6 class="dropdown-header">Detail</h6></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.exhibition.produsen.export', ['respondentId' => $form->respondent_id, 'format' => 'excel', 'type' => 'detail']) }}">
                                    <i class="bx bxs-file-export"></i> Excel Detail
                                </a></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.exhibition.produsen.export', ['respondentId' => $form->respondent_id, 'format' => 'pdf', 'type' => 'detail']) }}">
