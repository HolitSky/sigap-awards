                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('dashboard.form.produsen-dg.export.excel', ['q' => request('q')]) }}" class="btn btn-success">
                                                <i class="mdi mdi-file-excel me-1"></i> Export Excel
                                            </a>
                                            <a href="{{ route('dashboard.form.produsen-dg.export.csv', ['q' => request('q')]) }}" class="btn btn-info">
                                                <i class="mdi mdi-file-delimited me-1"></i> Export CSV
                                            </a>
                                            <a href="{{ route('dashboard.form.produsen-dg.export.pdf', ['q' => request('q')]) }}" class="btn btn-danger">
