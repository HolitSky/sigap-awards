...
@section('title', 'Detail Respon Produsen DG')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('dashboard.form.produsen-dg.index') }}" class="btn btn-light">
                        ...
                        <div class="mb-3">
                            <div><strong>Petugas</strong>: {{ $form->nama_petugas ?: '-' }}</div>
                        ...
                        <div class="mb-3">
                            <a href="{{ route('dashboard.form.produsen-dg.score.edit', $form->respondent_id) }}" class="btn btn-primary">Nilai Ulang Form</a>
                        </div>
                        @endif
...
<script>
    function showHistoryModal() {
        ...
        // Fetch history data
        fetch('{{ route('dashboard.form.produsen-dg.history', $form->respondent_id) }}')
