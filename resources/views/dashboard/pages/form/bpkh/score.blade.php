...
@section('title', 'Nilai Ulang Form BPKH')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <a href="{{ route('dashboard.form.bpkh.show', $form->respondent_id) }}" class="btn btn-light">
                                <i class="mdi mdi-arrow-left me-1"></i> Kembali
                            </a>
                        </div>
                        <h4 class="mb-3">Nilai Ulang Form — {{ $form->nama_bpkh }}</h4>
