...
<head>
    <meta charset="utf-8">
    <title>Data Form BPKH Detail - SIGAP Award 2025</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        <h1>Data Form Penilaian BPKH (Detail Lengkap)</h1>
        <p>SIGAP Award 2025 - Balai Pemantapan Kawasan Hutan</p>
    ...
    <div class="participant-section">
        <div class="participant-header">
            {{ $index + 1 }}. {{ $form->nama_bpkh ?? 'N/A' }}
        </div>
        
        <!-- Basic Information -->
        <div class="info-grid">
            <div class="info-row">
                <div class="info-label">Nama BPKH</div>
                <div class="info-value">{{ $form->nama_bpkh ?? '-' }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Petugas BPKH</div>
                <div class="info-value">{{ $form->petugas_bpkh ?? '-' }}</div>
            </div>
            <div class="info-row">
