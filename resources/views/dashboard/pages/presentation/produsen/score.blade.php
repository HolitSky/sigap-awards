...
@section('title', 'Nilai Presentasi Produsen DG')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('dashboard.presentation.produsen.update', $form->respondent_id) }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('dashboard.presentation.produsen.index') }}" class="btn btn-secondary">Batal</a>
                                    </div>
                                </div>
