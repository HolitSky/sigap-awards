...
@section('title', 'Detail Penilaian Presentasi Produsen DG')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label class="text-muted small">Bobot Presentasi</label>
                                    <h5>{{ number_format($form->bobot_presentasi, 0) }}%</h5>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                        ...
                        @if($form->kategori_skor)
                            <div class="alert alert-info">
                                <strong>Kategori Skor: {{ $form->kategori_skor }}</strong><br>
                                {{ $form->deskripsi_skor }}
                            </div>
                        @endif

                        <a href="{{ route('dashboard.presentation.produsen.edit', $form->respondent_id) }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach($form->penilaian_per_juri as $index => $penilaian)
                                            <tr>
                                                ...
                                                <td>{{ isset($penilaian['assessed_at']) ? \Carbon\Carbon::parse($penilaian['assessed_at'])->format('d/m/Y H:i') : '-' }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
