...
class ProdusenPresentationAssesment extends Model
{
    protected $table = 'produsen_presentasi_assesment';
    ...
    public function produsenForm()
    {
        return $this->belongsTo(ProdusenForm::class, 'synced_from_form_id');
    }
}
